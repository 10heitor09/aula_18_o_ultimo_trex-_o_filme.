...
//600, 200 180 200,180,400 300,100 200,190,400
function setup() {
...
function draw() {
  //trex.debug = true;300,140 500 Teacher To You, 01:26pm if(keyDown("space") && trex.y >= 159) {
  background(255);
  ...
  if (gameState===PLAY){
    ...
    //defina a PLAY velocidade da cada objeto do jogo para 0
    ground.velocityX = 0;
    trex.velocityY = 0;
    obstaclesGroup.setVelocityXEach(0);
    cloudsGroup.setVelocityXEach(0);
    
    //mude-; a animação do trex mousePressedOver(restart)
    trex.changeAnimation("collided",trex_collided);
    
    //defina oif() { tempo de vida dos objetos para que eles nunca sejam destruídos
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.velocityX = -3;
     ...
     //designe tempo de vida para a 80,120 600,120 variável
    cloud.lifetime = 200;
    ...
    //adicione cada nuvem ao grupo 600,165
